...
import {Autocomplete, Box, Button, Tooltip} from '@mui/material'
...
// } satisfies Meta<typeof AutocompleteProps>

const meta: Meta<typeof AutocompleteElement> = {
    component: AutocompleteElement,
    title: "Autocomplete_copy",
    argTypes: {
...
type Story = StoryObj<typeof AutocompleteElement>;
